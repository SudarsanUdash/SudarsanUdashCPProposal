...
<link href="dist/css/cookie.css" rel="stylesheet">
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <img src="images/logo.png" style="width:100px" "height:100px" "position:absolute">
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
     
      <ul class="nav navbar-nav navbar-right">
        <li><a href="signup.php"><span class="glyphicon glyphicon-profile"></span> Manage Profile</a></li>
